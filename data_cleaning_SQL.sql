...
-- Populate Adress with null values from rows that have it using the ParcelId column
...
-- Split OwnerAdress column into 3 columns : OwnerAdress, OwnerCity, OwnerState
...
-- Clean wrong characters in prices
